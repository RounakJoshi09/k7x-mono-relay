...
httpServer.listen(httpPort, "localhost", () => {
  ...
  setInterval(() => {
    //set timer to detect if webpage is open/closed via monitoring websocket clients
